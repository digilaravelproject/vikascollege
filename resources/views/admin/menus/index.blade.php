                        ...
                        @foreach($menus->where('parent_id', null)->sortBy('order') as $menu)
                            ...
                            <tbody x-data="{ open: true }" class="group">
                                ...
                                <tr class="transition cursor-pointer bg-gray-50 hover:bg-gray-100" @click="open = !open">
                                    <td class="flex items-center px-6 py-3 font-semibold text-gray-900">
                                ...
                                @foreach($menu->children->sortBy('order') as $child)
                                    <tr x-show="open" x-transition class="transition hover:bg-gray-50">
                                        <td class="flex items-center px-10 py-3 text-gray-700">
                                        ...
                                        <td class="px-6 py-3 text-center">
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" x-data="{ checked: {{ $child->status ? 'true' : 'false' }} }"
                                                    x-model="checked" @change="
                                    ...
                                    @foreach($child->children->sortBy('order') as $subchild)
                                        <tr x-show="open" x-transition class="transition hover:bg-gray-50">
                                            <td class="flex items-center py-3 italic text-gray-600 px-14">
                                            ...
                                            <td class="flex justify-center gap-2 px-6 py-3 text-center">
                                                ...
                                                <form action="{{ route('admin.menus.destroy', $subchild->id) }}" method="POST"
                                                    class="inline">
                                                    @csrf @method('DELETE')
