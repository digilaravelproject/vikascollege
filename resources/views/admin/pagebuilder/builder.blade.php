                    ...
                    <template x-for="(block, index) in blocks" :key="block.id">
                        <div class="relative p-4 mb-4 transition border rounded-lg bg-gray-50 hover:shadow group"
                            ...
                            <template x-if="block.type === 'section'">
                                                                            ...
                                                                            <template x-if="sub.data.length > 0">
                                                                                <thead class="bg-gray-100">
                                                                                    <tr
                                                                                        ...
                                                                                        <template x-for="(col, colIndex) in sub.data[0]"
                                                                                            :key="colIndex">
                                                                                    ...
                                                                                    <template x-if="rowIndex > 0">
                                                                                        <tr class="hover:bg-gray-50">
                                                                                            <template x-for="(cell, colIndex) in row"
                                                                                                :key="colIndex">
                                                                                                <td class="py-1 px-2 border-r border-gray-200 align-top">
                                                                                                    {{-- Using a textarea for multi-line support --}}
                                                                                                    <textarea x-model.debounce.400ms="sub.data[rowIndex][colIndex]"
                                                                                                        @input="pushHistory" rows="2"
                                                ...
                                                <template x-if="block.data.length > 0">
                                                    <thead class="bg-gray-100">
                                                        <tr class="text-xs text-gray-700 uppercase leading-normal">
                                                            <template x-for="(col, colIndex) in block.data[0]"
                                                                :key="colIndex">
                                                                <th class="py-2 px-3 border-r border-gray-200">
                                                                    <input type="text"
                                                        ...
                                                        <template x-if="rowIndex > 0">
                                                            <tr class="hover:bg-gray-50">
                                                                <template x-for="(cell, colIndex) in row" :key="colIndex">
                                                                    <td class="py-1 px-2 border-r border-gray-200 align-top">
                                                                        {{-- Using a textarea for multi-line support for the 'text and all' requirement --}}
                                ...
                                {{-- END: NEW TABLE ROOT BLOCK TEMPLATE --}}
            ...
            function pageBuilder(savedContent = null) {
                return {
                    availableBlocks: [{
                        ...
                        // END: NEW TABLE BLOCK DEFINITION
                    ],
                    blocks: [],
                    quills: {},
                    historyStack: [],
