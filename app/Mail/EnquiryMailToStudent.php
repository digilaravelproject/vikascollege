...
class EnquiryMailToStudent extends Mailable
{
    ...
    {
        return new Content(
            // Assuming the view is located at resources/views/emails/enquiry_student.blade.php
            view: 'emails.enquiry_student',
            with: [
